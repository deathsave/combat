/*
    ...
    3. Modified the SmartMatrix library references
    4. Reduced brightness to 40%
    5. Reduced DMA buffer rows to 3
*/
...
const uint8_t kDmaBufferRows = 3;       // known working: 2-4, use 2 to save memory, more to keep from dropping frames and automatically lowering refresh rate
...
const int defaultBrightness = 40*(255/100);    // full brightness
